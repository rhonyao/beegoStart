...
//获取accessToken
func GetGithubAccessToken(code string , env string) (token GithubAccessToken, err error) {
	var resp string
	Api := beego.AppConfig.String("oauth::githubAccesstoken")
	ClientId := beego.AppConfig.String("oauth::githubClientId_" + env )
	ClientSecret := beego.AppConfig.String("oauth::githubClientSecret_" + env)
	Callback := beego.AppConfig.String("oauth::githubClientCallback_" + env)
